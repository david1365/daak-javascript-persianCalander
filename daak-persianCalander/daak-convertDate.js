...
var daak = {
    ...
    yearsCount128AGES: this.Count128Circuit * this.yearsCount128,
    ...
    parsiMonthName: {   1:'فروردین',
                        ...
                        12:'اسفند'},
    //روزهای هفته
    parsiDayOfWeek: [ "شنبه", "يكشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنجشنبه", "جمعه" ],
   ...
   */
        ...
        return Math.ceil(parsiYear / parseFloat(this.yearsCountBigAGE));//ما سقف عدد بدست آمده را می خواهیم زیرا رقم سمت راست به این معنی است که وارد دوره شده است
    }
}
